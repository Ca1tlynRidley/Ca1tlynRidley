...
- Full NBT-based entity capture/release, preserving villager professions and trades
- Custom mixins to intercept vanilla GUIs (villager trading) for capture-on-shift-click
- Custom item rendering: dynamic tooltips, enchantment glint, and colored display name
